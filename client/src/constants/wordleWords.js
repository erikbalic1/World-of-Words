// List of valid 5-letter words for Wordle game
export const WORDLE_WORDS = [
  ...
  'baton', 'batty', 'bawdy', 'bayou', 'beach', 'beady', 'beard', 'beast', 'beget', 'began',
  ...
  'bleat', 'bleed', 'bless', 'blimp', 'blind', 'blink', 'bliss', 'blitz', 'bloat', 'block',
  'bloke', 'blonde', 'blood', 'bloom', 'blown', 'bluer', 'blues', 'bluff', 'blunt', 'blurb',
  ...
  'chill', 'chime', 'chimp', 'china', 'chirp', 'chive', 'chock', 'choir', 'choke', 'chord',
  ...
  'comet', 'comfy', 'comic', 'comma', 'conch', 'condo', 'conic', 'coral', 'corny', 'couch',
  ...
  'drama', 'drank', 'drape', 'drawl', 'drawn', 'dread', 'dream', 'drear', 'dregs', 'dress',
  ...
  'extra', 'exude', 'exult', 'eying', 'fable', 'facet', 'faint', 'fairy', 'faith', 'fake',
  'faker', 'falls', 'false', 'fancy', 'fanny', 'farce', 'fatal', 'fatty', 'fault', 'fauna',
  'favor', 'feast', 'fecal', 'feign', 'faint', 'feint', 'fella', 'felon', 'femme', 'femur',
  'fence', 'feral', 'ferry', 'fetal', 'fetch', 'fetid', 'fetus', 'fever', 'fewer', 'fiber',
  'fibre', 'ficus', 'field', 'fiend', 'fiery', 'fifth', 'fifty', 'fight', 'filer', 'filet',
  ...
  'gnash', 'gnome', 'godly', 'going', 'golem', 'golly', 'gonad', 'goner', 'goody', 'gooey',
  ...
  'hello', 'hence', 'henge', 'henry', 'heron', 'hilly', 'hinge', 'hippo', 'hippy', 'hitch',
  ...
  'jenny', 'jerky', 'jetty', 'jewel', 'jiffy', 'jimmy', 'joint', 'joist', 'joker', 'jolly',
  'jolty', 'joust', 'judge', 'juice', 'juicy', 'jumbo', 'jumpy', 'junta', 'juror', 'kappa',
  'karma', 'kayak', 'kazoo', 'kebab', 'khaki', 'kinky', 'kiosk', 'kitty', 'knack', 'knave',
  ...
  'oxide', 'ozone', 'pagan', 'pager', 'palsy', 'panel', 'panic', 'pansy', 'papal', 'paper',
  ...
  'royal', 'ruddy', 'ruder', 'rugby', 'ruler', 'rumba', 'rumor', 'rupee', 'rural', 'rushy',
  ...
  'smite', 'smith', 'smock', 'smoke', 'smoky', 'smote', 'snack', 'snag', 'snail', 'snake',
  ...
  'stink', 'stint', 'stock', 'stoic', 'stomp', 'stone', 'stony', 'stood', 'stool', 'stoop',
  ...
  'sushi', 'swab', 'swami', 'swamp', 'swank', 'swarm', 'swash', 'swath', 'swear', 'sweat',
  'sweep', 'sweet', 'swell', 'swept', 'swift', 'swill', 'swine', 'swing', 'swipe', 'swirl',
  'swish', 'swiss', 'swoon', 'swoop', 'sword', 'swore', 'sworn', 'swung', 'synod', 'syrup',
  ...
  'thump', 'thunk', 'tiara', 'tibia', 'tidal', 'tiger', 'tight', 'tilde', 'timer', 'timid',
  ...
  'train', 'trait', 'tramp', 'trash', 'trawl', 'tray', 'tread', 'treat', 'treaty', 'treble',
  'trend', 'triad', 'trial', 'tribe', 'trice', 'trick', 'tried', 'trier', 'trike', 'trill',
  ...
  'under', 'undid', 'undue', 'unfed', 'unfit', 'unify', 'union', 'unity', 'unlit', 'unmet',
  'unset', 'until', 'unwed', 'unzip', 'upper', 'upset', 'urban', 'urine', 'usage', 'usher',
  'using', 'usual', 'usurp', 'utensil', 'utter', 'vague', 'valet', 'valid', 'valor', 'value',
  'valve', 'vapid', 'vapor', 'vault', 'vaunt', 'vegan', 'venom', 'venue', 'verge', 'verse',
  'verso', 'verve', 'vicar', 'video', 'vigil', 'vigor', 'villa', 'vinyl', 'viola', 'viper',
  'viral', 'vireo', 'virus', 'visit', 'visor', 'vista', 'vital', 'vivid', 'vixen', 'vocal',
  ...
  'wiper', 'wired', 'wiser', 'wispy', 'witch', 'witty', 'woken', 'woman', 'women', 'woody',
